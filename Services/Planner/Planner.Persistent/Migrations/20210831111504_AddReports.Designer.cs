...
namespace Planner.Persistent.Migrations
{
    ...
    [Migration("20210831111504_AddReports")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Planner.Domain.AggregatesModel.GoalAggregate.Entities.GoalStatusItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Planner.Domain.AggregatesModel.GoalAggregate.Entities.GoalStatusItem", b =>
                {
                    b.HasOne("Planner.Domain.AggregatesModel.GoalAggregate.Entities.Goal", null)
                        .WithMany("Items")
                        .HasForeignKey("GoalId")
                        .HasConstraintName("fk_goal_status_items_goals_goal_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
